...
RSpec.describe 'when a visitor visits the astronaut index page', type: :feature do
  before :each do
    ...
    @astronaut_2 = Astronaut.create(name: 'Stuart Roosa', age: 25, job: 'Command Module Pilot', missions: [@mission_1])
    @astronaut_3 = Astronaut.create(name: 'Edgar Mitchell', age: 25, job: 'Lunar Module Pilot', missions: [@mission_1] )
  end
